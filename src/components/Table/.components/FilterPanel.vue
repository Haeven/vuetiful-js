<template>
  <div class="filter-panel-wrap" @click.stop.prevent="">
    <transition name="zoom-in-top" @enter="handleEnter" @after-enter="handleAfterEnter" @after-leave="handleAfterLeave">
      <div v-show="isShow.value" class="filter-content" :style="{ top: y, left: x }" ref="content">
